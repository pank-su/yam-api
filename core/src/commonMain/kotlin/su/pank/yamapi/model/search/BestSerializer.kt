...
object BestSerializer : KSerializer<Best> {
    override val descriptor: SerialDescriptor
        get() =
            buildClassSerialDescriptor("BlockEntity") {
                element("type", serialDescriptor<QueryResponseType>())
                element("result", buildClassSerialDescriptor("Any"))
            }

    private fun getResultSerializer(type: QueryResponseType): KSerializer<Any> =
        when (type) {
    ...
    override fun deserialize(decoder: Decoder): Best =
